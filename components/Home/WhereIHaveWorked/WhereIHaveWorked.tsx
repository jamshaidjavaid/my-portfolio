...
import UeItSociety from "./Descriptions/UeItSociety";
...
export default function WhereIHaveWorked() {
  ...
  const GetDescription = () => {
    switch (DescriptionJob) {
      ...
      case "Digital Dynamics":
        return <DigitalDynamics />;
      case "Webwrite Inc. Itern":
...
const CompaniesBar = (props) => {
  ...
  return (
    ...
    >
      {/* // ? left bar Holder */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[213px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Webwrite Inc."
            BarPosition={-7}
            BarAvobePosition={1}
            DescriptionJob="Webwrite Inc."
            CompanyNameBackgroundColorGreen={[
              true,
              false,
              false,
          ...
          <CompanyButton
            ...
            DescriptionJob="Digital Dynamics"
            CompanyNameBackgroundColorGreen={[
              false,
              true,
              false,
          ...
          <CompanyButton
            ...
            DescriptionJob="Webwrite Inc. Itern"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              true,
          ...
          <CompanyButton
            ...
            CompanyName="SKMCH, Lahore"
            BarPosition={125}
            BarAvobePosition={385}
            DescriptionJob="SKMCH, Lahore"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
          ...
          <CompanyButton
            ...
            CompanyName="UE IT Society"
            BarPosition={169}
            BarAvobePosition={513}
            DescriptionJob="UE IT Society"
            CompanyNameBackgroundColorGreen={[
              false,
              false,
              false,
