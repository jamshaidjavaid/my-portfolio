...
export default function Home() {
  ...
  const meta = {
    title: "Jamshaid Javaid - Software Engineer",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://jamshaidjavaid.com`} />
        <link rel="canonical" href={`https://jamshaidjavaid.com`} />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Jamshaid Javaid" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@jamshaid_" />
